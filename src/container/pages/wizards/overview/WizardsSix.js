            ...
            steps={[
              {
                title: (
                  <div className="wizard-item">
                    ...
                    <img src={require(`../../../../static/img/wizards/${status !== 'finish' ? 1 : 1}.svg`)} alt="" />
                  </div>
                ),
                content: (
              ...
              },
              {
                title: (
                  <div className="wizard-item">
                    ...
                    <p>Lorem Ipsum is simply dummy text of the dummy typesetting industry.</p>
                    <img
                      src={require(`../../../../static/img/wizards/${status !== 'finish' ? '1-1' : '1-1'}.svg`)}
                      alt=""
                    />
                  </div>
                ),
              ...
              },
              {
                title: (
                  <div className="wizard-item">
                    ...
                    <p>Lorem Ipsum is simply dummy text of the dummy typesetting industry.</p>
                    <img src={require(`../../../../static/img/wizards/${status !== 'finish' ? 2 : 2}.svg`)} alt="" />
                  </div>
                ),
                content: (
                  <BasicFormWrapper className="basic-form-inner">
